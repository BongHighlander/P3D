...
t_triangle3d *copierTriangle3d(t_triangle3d *t)
{
	...
	n0 = definirPoint3d(t->abc[0]->xyzt[0],t->abc[0]->xyzt[1],t->abc[0]->xyzt[2]); //On prend soin de redéfinir des nouveau points, copiant les anciens, pour créer ces triangles
